              ...
              children: [
                Align(
                    ...
                    child: Padding(
                      ...
                      child: Text("${widget.price} AED", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 32),),
                    )),
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        if (widget.hasHandle) Handle(cardIsExpanded: _cardIsExpanded),
                        SizedBox(height: 10),
                        Expanded(
                          child: ListView(
...
class Handle extends StatelessWidget {
  bool cardIsExpanded =false;
   Handle({required this.cardIsExpanded,super.key});
